        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-3 right-3 border border-border bg-background/85 text-foreground hover:bg-muted dark:border-white/15 dark:bg-black/85 dark:text-white dark:hover:bg-black"
                size="icon-sm"
              />
            }
          >
