  ...
  function initBG() {
    ...
    if (particles1) {
      particles1.style.cssText =
        "width:1px;height:1px;border-radius:50%;box-shadow:" +
        particlesSmall +
        ";animation:animStar 50s linear infinite;";
    }
    if (particles2) {
      particles2.style.cssText =
        "width:1.5px;height:1.5px;border-radius:50%;box-shadow:" +
        particlesMedium +
        ";animation:animateParticle 100s linear infinite;";
    }
    if (particles3) {
      particles3.style.cssText =
        "width:2px;height:2px;border-radius:50%;box-shadow:" + particlesLarge + ";";
    }
    ...
    if (stars2)
      stars2.style.cssText =
        "width:1.5px;height:1.5px;border-radius:50%;box-shadow:" +
        starsMedium +
        ";animation:animateParticle 140s linear infinite;";
    if (stars3)
      stars3.style.cssText =
        "width:2px;height:2px;border-radius:50%;box-shadow:" + starsLarge + ";";
  }
